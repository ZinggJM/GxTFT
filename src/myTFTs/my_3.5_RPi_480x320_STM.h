...
#include "../GxCTRL/GxCTRL_ILI9486_WSPI/GxCTRL_ILI9486_WSPI.h" // 320x480 e.g. 3.5inch RPI Display
//GxIO_Class io(SPI, SS, 6, 5); // don't use with official STM32 boards group package
GxIO_SPI_USING_TRANSACTION io(SPI, SS, 6, 5); // 480x320 3.5inch RPI Display on ST-Nucleo F103RB
