...
#ifndef _GxIO_STM32Nucleo144_FSMC_H_
#define _GxIO_STM32Nucleo144_FSMC_H_
...
class GxIO_STM32Nucleo144_FSMC : public GxIO
{
  public:
    GxIO_STM32Nucleo144_FSMC(bool bl_active_high = false);
    const char* name = "GxIO_STM32Nucleo144_FSMC";
    void reset();
    void init();
...
#define GxIO_Class GxIO_STM32Nucleo144_FSMC
