...
class GxIO_STM32F103ZET6M3_FSMC : public GxIO
{
  public:
    GxIO_STM32F103ZET6M3_FSMC(bool bl_active_high = true);
    const char* name = "GxIO_STM32F103ZET6M3_FSMC";
    void reset();
    void init();
...
#define GxIO_Class GxIO_STM32F103ZET6M3_FSMC
