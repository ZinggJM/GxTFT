...
#ifndef _GxCTRL_RA8875P_H_
#define _GxCTRL_RA8875P_H_

#include "../GxCTRL.h"

class GxCTRL_RA8875P : public GxCTRL
{
  public:
    GxCTRL_RA8875P(GxIO& io) : GxCTRL(io), _tft_width(800), _tft_height(480) {};
    GxCTRL_RA8875P(GxIO& io, uint16_t tft_width, uint16_t tft_height) : GxCTRL(io), _tft_width(tft_width), _tft_height(tft_height) {};
    const char* name = "GxCTRL_RA8875P";
...
#define GxCTRL_Class GxCTRL_RA8875P
