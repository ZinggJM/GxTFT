...
//#include <GxIO/GxIO_DUE_P16_MEGASHIELD/GxIO_DUE_P16_MEGASHIELD.h>
//#include <GxIO/GxIO_DUE_P16_TIKY/GxIO_DUE_P16_TIKY.h>
//#include <GxIO/GxIO_DUE_P16_WIRED/GxIO_DUE_P16_WIRED.h>
//#include <GxIO/GxIO_MEGA_P16_SHIELD/GxIO_MEGA_P16_SHIELD.h>
...
// select one or adapt
//TFT_Class tft(io, controller, 240, 320); // 240x320
//TFT_Class tft(io, controller, 320, 240); // 240x320
...
void reportID()
{
  ...
  uint16_t rr36 = readReg(0x36);
  uint16_t rrBA = readReg(0xBA);
  uint16_t rrBF = readReg(0xBF);
  uint16_t rrC7 = readReg(0xC7);
  uint16_t rrF3 = readReg(0xF3);
  uint16_t rrF7 = readReg(0xF7);
  tft.fillScreen(BLACK);
  tft.setCursor(0, 0);
  tft.setTextColor(WHITE);  tft.setTextSize(2);
  tft.print("readReg40(0xBF) :  0x"); tft.println(rr40BF, HEX);
  tft.print("readReg(0)      :  0x"); tft.println(rr0, HEX);
  //  tft.print("readReg(0x36)   :  0x"); tft.println(rr36, HEX);
  //  tft.print("readReg(0xBA)   :  0x"); tft.println(rrBA, HEX);
  //  tft.print("readReg(0xBF)   :  0x"); tft.println(rrBF, HEX);
  //  tft.print("readReg(0xC7)   :  0x"); tft.println(rrC7, HEX);
  //  tft.print("readReg(0xF3)   :  0x"); tft.println(rrF3, HEX);
  //  tft.print("readReg(0xF7)   :  0x"); tft.println(rrF7, HEX);
  tft.println();
  Serial.print("readReg40(0xBF) :  0x"); Serial.println(rr40BF, HEX);
  Serial.print("readReg(0xBF)   :  0x"); Serial.println(rrBF, HEX);
  //  Serial.print("readReg(0xBA)   :  0x"); Serial.println(rrBA, HEX);
  //  Serial.print("readReg(0xBF)   :  0x"); Serial.println(rrBF, HEX);
  //  Serial.print("readReg(0xC7)   :  0x"); Serial.println(rrC7, HEX);
  //  Serial.print("readReg(0xF3)   :  0x"); Serial.println(rrF3, HEX);
  //  Serial.print("readReg(0xF7)   :  0x"); Serial.println(rrF7, HEX);
  Serial.println();
}
