// GxTFT example for TIANMA 2.8 inch 37P SPI TFT LCD Module ILI9341 Drive IC 240*320 TM028HDZ25 RGB Interface
// https://www.aliexpress.com/item/TIANMA-2-8-inch-37PIN-TFT-LCD-Module-ILI9341-Drive-IC-240-RGB-320-SPI-RGB/32267693877.html
// 
// adapted by Jean-Marc Zingg to be an example for the GxTFT library
// original source taken from https://github.com/Bodmer/TFT_HX8357
// Original header is at the end of the sketch, ...
...
void setup()
{
  ...
  GxReportRegisters();
  delay(5000);
  tft.init(); // reset registers after GxReportRegisters()
  GxTestReadGRAM();
  delay(5000);
